...
namespace ARManila.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async System.Threading.Tasks.Task<ActionResult> AddPhoneNumber(AddPhoneNumberViewModel model)
        {
            ...
            //await Utility.SendSMS(model.Number, "Your security code is: " + code, "codeverification", employee.EmployeeID);
